    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">
              Urgent incidents (immediate danger)
            </span>
          </div>
        </button>
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">General crime reports</span>
          </div>
        </button>
      </div>
      ...
      <div className="relative group">
        ...
        <label
          ...
          className="block w-full p-8 border-2 border-dashed border-zinc-700 rounded-2xl 
                   hover:border-teal-500/50 hover:bg-teal-500/5 transition-all duration-200
        ...
        >
          {image ? (
            <div className="space-y-4">
              ...
              <p className="text-sm text-zinc-400">Click to replace evidence</p>
            </div>
          ) : (
            <div className="space-y-4">
              <svg
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g. Armed robbery near Central Park"
          className="w-full rounded-xl bg-zinc-900/50 border border-zinc-800 px-4 py-3.5
                   text-white transition-colors duration-200
                   focus:outline-none focus:ring-2 focus:ring-teal-600/40"
          required
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          placeholder="Provide details about the incident. Do not include personal info."
          className="w-full rounded-xl bg-zinc-900/50 border border-zinc-800 px-4 py-3.5
                   text-white transition-colors duration-200
      ...
      <button
        ...
        className="w-full relative group overflow-hidden rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 
                 px-4 py-3.5 text-sm font-medium text-white shadow-lg
                 transition-all duration-200 hover:from-teal-400 hover:to-teal-500
