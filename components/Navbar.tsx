...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full border-b border-white/5 bg-black/70 backdrop-blur-xl z-50">
            ...
            <div className="flex items-center space-x-3">
              <Link href="/" className="flex items-center space-x-2">
                <Image
                  ...
                  width={150}
                  height={100}
                  className="rounded-md drop-shadow-[0_0_20px_rgba(0,255,255,0.6)] hover:drop-shadow-[0_0_35px_rgba(0,255,255,0.9)] transition-all duration-300"
                  priority
                />
              </Link>
            </div>
