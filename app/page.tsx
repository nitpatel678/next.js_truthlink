    ...
    <main className="relative px-6 pt-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex h-9 items-center gap-2 rounded-full border border-teal-500/20 bg-teal-600/10 px-4 text-sm text-teal-600">
            <svg
              className="h-4 w-4"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link href={"/submit-report"}>
              <button className="group relative flex h-12 items-center justify-center gap-2 rounded-xl bg-teal-500 px-8 text-sm font-medium text-white transition-all hover:bg-teal-600">
        ...
        <div className="mt-40 grid gap-6 sm:grid-cols-3">
          {[
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-b from-teal-500/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 mt-20 py-8 text-center text-sm text-zinc-500">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 px-6">
          <p>© {new Date().getFullYear()} TruthLink. All rights reserved.</p>
